<script>
    // No scripts needed for this static component
</script>
...
>
    <div
        class="h-80 w-80 rounded-full bg-linear-to-tr from-blue-500 opacity-50 blur-[160px]"
    ></div>
</div>
<div
...
>
    <div
        class="h-80 w-80 rounded-full bg-linear-to-tr from-blue-500 to-gray-900 opacity-50 blur-[160px]"
    ></div>
</div>
<div
