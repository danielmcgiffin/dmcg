...
description: "What a first operations hire needs from a founder: clear ownership, decision authority, and an honest account of how the business runs."
...
I was a founder's first operations hire. Over roughly two years, the role cost about $300,000. We did not build the durable operating systems the business needed. I was part of that failure, and it changed how I think about the role.
...
### Path A: the work stays undefined

If owners remain unnamed, decision boundaries stay unsettled, and every important call still returns to the founder…
...
They may become an expensive witness to a problem neither of you has had room to define: the business still relies on the founder's preferences rather than shared operating rules.
